  <div class="content">
    <h1 class="text-center mt-5">Gems for Sale!</h1>

    <div class="container-fixed">
      <div class="container mt-5">
        <div class="row mt-4">
          <div class="col-sm-4">
            <h2 class="img-responsive text-center">Amethyst</h2>
            <img
              class="img-fluid"
          ...
          <div class="col-sm-4">
            <h2 class="img-responsive text-center">Emerald</h2>
            <img
              class="img-fluid"
              alt="Emerald-Picture"
          ...
          <div class="col-sm-4">
            <h2 class="img-responsive text-center">Diamond</h2>
            <img
              class="img-fluid"
              alt="Diamond-Picture"
    ...
    <div class="container-fixed">
      <div class="container mt-5 mb-5">
        <div class="row mt-4">
          <div class="col-sm-4">
            <h2 class="img-responsive text-center">Quartz</h2>
            <img
              class="img-fluid"
              alt="Quartz-Picture"
          ...
          <div class="col-sm-4">
            <h2 class="img-responsive text-center">Citrine</h2>
            <img
              class="img-fluid"
              alt="Citrine-Picture"
          ...
          <div class="col-sm-4">
            <h2 class="img-responsive text-center">Flourite</h2>
            <img
              class="img-fluid"
